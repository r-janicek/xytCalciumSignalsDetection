...
class TempRedUNet(nn.Module):
    def __init__(self, unet_config):
        ...
        padding = {'valid': 0, 'same': unet_config.dilation}[
            unet_config.border_mode]
...
class ConvLSTMCell(nn.Module):
    ...
    def __init__(self, input_channels, hidden_channels, kernel_size, bias):
        ...
        if isinstance(kernel_size, int):
            ...
            raise ValueError(
                "Invalid kernel_size. Must be of type int or tuple but was {}".format(type(kernel_size)))
...
class ConvLSTM(nn.Module):
    ...
    def __init__(self, input_channels, hidden_channels, kernel_size,
        ...
        hidden_channels = self._extend_for_multilayer(
...
class UNetConvLSTM(unet.UNet):
    ...
    def __init__(self, config, bidirectional=False):
        ...
        self.convLSTM1 = ConvLSTM(input_channels=n_channels1,
        ...
        self.convLSTM2 = ConvLSTM(input_channels=n_channels2,
        ...
        if bidirectional:
            ...
            self.conv_bidirectional = nn.Conv2d(in_channels=n_channels1,
                                                out_channels=n_channels1,
                                                kernel_size=(1, 1))
